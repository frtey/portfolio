  ...
  Grimoire: {
    ...
    complements: {
      ...
      temps: [
        ...
        "au début¤1",
        "juste avant que le jour ne lève¤3",
  ...
  graphSondage: {
    questions: {
      qui: [
        ...
        "Qui a <tout appris|pour but de ressembler|confie tous ses secrets|toujours fait des miseres|la manie de comparer|l'art de remonter le moral> a $F ?_perF",
        ...
        "Qui ne peut pas <empecher de|arreter de|decider a|convaincre les autres de|envisager de|refuser de|accepter de|faire semblant de> +V ?",
      ...
      ou: [
        "Ou aimeriez-vous <passer vos vacances|aller vivre a partir de|voir survenir une catastrophe|que la qualite de vie ameliore> l'annee prochaine ?",
        "Ou habitiez-vous <au 1er janvier 2010|durant votre enfance|pendant vos etudes|dans votre dernier reve> ?",
        "Ou derouleront les prochains <jeux olympiques|grands evenements historiques|episodes de \"Plus belle la vie\"> ?",
        "En cas <de conflit atomique international|de seisme|d'innondation>,"
        + " ou pensez-vous qu'il serait plus <judicieux|prudent|sur> de <refugier|cacher|stocker les aliments> ?",
        ...
        "Quand une menace terroriste abat sur le pays, ou est-il <prudent|necessaire|urgent> de"
        + " <perquisitionner|envoyer l'armee|surveiller les allees et venues> <en premier lieu|avant tout|immediatement> ?",
        "Ou $M sent-il le plus <dans son element|admire|a l'aise|tendu> ?",
      ...
      quand: [
        ...
        "Quand $M <est-il ne|est-il marie|est-il mort|a-t-il ete connu> ?¤1",
      ...
      quoi: [
        ...
        "Que faut-il faire <chaque soir|chaque jour|une fois de temps en temps> avant de <coucher|manger|rentrer chez soi> ?",
      ...
      fermee: [
        ...
        "Pensez-vous que $ <puisse|doive|apprete a|reve de|ait le droit de|interdise de> +V ?",
